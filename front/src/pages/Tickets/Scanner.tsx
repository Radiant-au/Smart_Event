...
const Scanner = () => {
  ...
  const userId = (location as any)?.state?.userId as string | number | undefined;
  ...
  useEffect(() => {
    ...
    html5QrCode
      ...
      .catch((err) => {
        setScanResult({
          valid: false,
          message: 'Cannot access camera. Please allow camera permission or use manual mode.',
          barcode: undefined,
        });
      });
        ...
        {mode === 'manual' ? (
          ...
          <Card className="mb-6">
            <CardHeader>
              ...
              <CardDescription>Use your webcam to scan a barcode</CardDescription>
            </CardHeader>
            <CardContent>
